...
// ***************************************
CParticleEmitter* g_p_myEmitter;	
// ***************************************
...
unsigned int g_mazeID = 0;
std::vector<unsigned int> g_mobID;
std::vector<unsigned int> g_vecMazeIDs;
...
std::vector<Light> vecLightsInfo;
