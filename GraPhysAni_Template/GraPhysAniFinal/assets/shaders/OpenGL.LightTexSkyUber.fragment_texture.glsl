...
void main(void)
{
	...
	if((final_outColour.r + final_outColour.g + final_outColour.b) /3.0f < 0.15f)
	{
		final_outColour.r = final_outColour.g = final_outColour.b = 0.0f;
	}
	if((final_outColour.r + final_outColour.g + final_outColour.b) /3.0f > 0.85f)
	{
		final_outColour.r = final_outColour.g = final_outColour.b = 1.0f;
	}
	

	/*if(final_outColour.r < 0.25f){
		final_outColour.r = 0.0f;
	}
	if(final_outColour.g < 0.25f){
		final_outColour.g = 0.0f;
	}
	if(final_outColour.b < 0.25f){
		final_outColour.b = 0.0f;
	}
	if(final_outColour.r > 0.75f){
		final_outColour.r = 1.0f;
	}
	if(final_outColour.g > 0.75f){
		final_outColour.g = 1.0f;
	}
	if(final_outColour.b > 0.75f){
		final_outColour.b = 1.0f;
	}*/
