...
*/
	...
	//	CGameObject* pTempObject = new CGameObject();		// CGameObject
	//	pTempObject->setMediator( this );
	//	pTempObject->meshDescription.modelName = BUNNY_PLY_FILENAME;
	//	pTempObject->meshDescription.scale = CVector3f(initScale);
	//	pTempObject->physicalProperties.position = initPosition;
	//}

	//if ( type == BASIC_GAME_OBJECT )		// "Basic Rendered Object";
	//{
	//	// Note constructor passes itself through the "this" pointer
	//	CGameObject* pTempObject = new CGameObject();		// CGameObject
	//	pTempObject->setMediator( this );
	//	pTempObject->meshDescription.modelName = TEAPOT_PLY_FILENAME;
	//	pTempObject->meshDescription.scale = CVector3f(initScale);
	//	pTempObject->physicalProperties.position = initPosition;
	//	return pTempObject;
	//}
	...
	//	CGameObject* pTempObject = new CGameObject();		// CGameObject
	//	pTempObject->setMediator( this );
	//	pTempObject->meshDescription.modelName = SPHERE_PLY_FILENAME;
	//	pTempObject->meshDescription.scale = CVector3f(initScale);
	//	pTempObject->physicalProperties.position = initPosition;
	//	return pTempObject;
	//}
	...
	//	CGameObject* pTempObject = new CGameObject();		// CGameObject
	//	pTempObject->setMediator( this );
	//	pTempObject->meshDescription.modelName = GALACTICA_PLY_FILENAME;
	//	pTempObject->meshDescription.scale = CVector3f(initScale);
	//	pTempObject->physicalProperties.position = initPosition;
	//	
	//	pTempObject->bIsFlame = false;
	...
	//	CGameObject* pTempObject = new CGameObject();		// CGameObject
	//	pTempObject->setMediator( this );
	//	pTempObject->meshDescription.modelName = VIPER_PLY_FILENAME;
	//	pTempObject->meshDescription.scale = CVector3f(initScale);
	//	pTempObject->physicalProperties.position = initPosition;
	//	return pTempObject;
	//}	
	//else if ( type == "Sphere UV SkyBox" )
	//{
	//	// Note constructor passes itself through the "this" pointer
	//	CGameObject* pTempObject = new CGameObject();		// CGameObject
	//	pTempObject->setMediator( this );
	//	pTempObject->meshDescription.modelName = SKYBOX_PLY_FILENAME;
	//	pTempObject->meshDescription.scale = CVector3f(initScale);
	//	pTempObject->physicalProperties.position = initPosition;
	//	pTempObject->bIsSkybox = true;	// ****
	//	return pTempObject;
	//}	
	//else if ( type == "Six Sided Star" )
	//{
	//	CGameObject* pTempObject = new CGameObject();		// CGameObject
	//	pTempObject->setMediator( this );
	//	pTempObject->meshDescription.modelName = SIX_SIDED_STAR_PLY_FILENAME;
	//	pTempObject->meshDescription.scale = CVector3f(initScale);
	//	pTempObject->physicalProperties.position = initPosition;
	//	//pTempObject->bIsFlame = true;
	//	return pTempObject;
	//}	
	//else if ( type == "Six Sided Cluster" )
	//{
	//	CGameObject* pTempObject = new CGameObject();		// CGameObject
	//	pTempObject->setMediator( this );
	//	pTempObject->meshDescription.modelName = SIX_SIDED_CLUSTER_PLY_FILENAME;
	//	pTempObject->meshDescription.scale = CVector3f(initScale);
	//	pTempObject->physicalProperties.position = initPosition;
	//	pTempObject->bIsFlame = true;
	//	return pTempObject;
...
//bool CFactoryMediator::setRenderingPropertiesByID( unsigned int ID, CMeshDesc &meshDesc )
//{
//	CGameObject* pTheGO = this->m_findObjectByID( ID );
//	if ( pTheGO == 0 )
//	{
...
//	}
//	// Found it
//	return pTheGO->setMeshDescription( meshDesc );
//}
