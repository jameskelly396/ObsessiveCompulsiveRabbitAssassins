...
private:
	static const unsigned int DEFAULT_MAX_NUMBER_OF_LIGHTS = 1;  //Also change max light value in ShaderUniformVariable.h and OpenGL.LightTexSkyUber.fragment_texture.glsl
